...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new io.swagger.v3.oas.models.info.Info().title("Esthete Filter Service API")
                        .description("Esthete Filter Service LIST")
                        .version("0.0.1"))
                ...
                .servers(Arrays.asList(
                        ...
                        new io.swagger.v3.oas.models.servers.Server().url("http://43.201.228.22:8040").description("Test Server"),
